...
const styles = StyleSheet.create({
  ...
  header: { marginBottom: 20, paddingBottom: 15, borderBottom: '2px solid #EF4444' },
  ...
  sectionHeader: { backgroundColor: '#1F2937', color: '#ffffff', padding: 8, fontSize: 12, fontWeight: 'bold', marginBottom: 10 },
  ...
  col: { flex: 1 },
  serviceTag: { backgroundColor: '#FEE2E2', color: '#991B1B', padding: '4 8', borderRadius: 4, fontSize: 9, marginRight: 8, marginBottom: 8 },
  ...
  totalLabel: { fontSize: 8, color: '#9CA3AF', textTransform: 'uppercase', marginBottom: 4 },
